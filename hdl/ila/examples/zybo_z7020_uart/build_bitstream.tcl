...
#
# Output: vivado_proj/uart_ila.runs/impl_1/uart_ila_top.bit
...
# ------------------------------------------------------------------
create_project uart_ila $proj_dir -part xc7z020clg400-1 -force
...
wait_on_run impl_1
set bit_file [file join $proj_dir uart_ila.runs impl_1 uart_ila_top.bit]
if {![file exists $bit_file]} {
    puts "ERROR: Implementation failed — bitstream not found at $bit_file"
    exit 1
}
