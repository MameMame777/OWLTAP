...
| 4 Capture and ILA migration | Done | waveform capture and ILA status operate through daemon |
| 5 Remove GUI direct FTDI ownership | Done | normal GUI mode has no direct `FtdiDevice` ownership (daemon path) |
